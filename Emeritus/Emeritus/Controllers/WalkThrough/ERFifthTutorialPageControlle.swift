//
//  ERFifthTutorialPageControlle.swift
//  Emeritus
//
...
class ERFifthTutorialPageControlle: UIViewController {
    ...
    */
    ...
    // MARK: - Proceed Action
    @IBAction func proceedButtonAction(sender: AnyObject) {
        
        //        let loginViewControllerObj = UIStoryboard(name: "Login", bundle: nil).instantiateViewControllerWithIdentifier("LoginNavigationViewController") as UINavigationController
        //        self.presentViewController(loginViewControllerObj, animated:false, completion: nil);
